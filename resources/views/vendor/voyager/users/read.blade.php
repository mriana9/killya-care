        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    $lastChar = $matches[1];
                    $user = App\Models\User::where('id',$lastChar)->first();
                ...
                <div class="container">
                    ...
                    @foreach(App\Models\Appointment::where('user_id', $user->id)
                                ->whereBetween('appointment', [$fromDate, $toDate])
                                ->orderBy('appointment')->get() as $appointment)
                        <div class="container">
                            <h5>Appointment:</h5>
                            <strong>{{ \Carbon\Carbon::parse($appointment->appointment)->format('Y-m-d H:i:s') }}</strong>
                        </div>
                    @endforeach
